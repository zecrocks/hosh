//! Hosh Discovery - Server discovery and registration service.
//!
//! This crate discovers and registers new light wallet servers (BTC/ZEC) into
...
const ZEC_SERVERS: &[(&str, u16, bool)] = &[
    ...
    ("z.ombie.cash", 443, true),
    ("lwd.bunny-zec.xyz", 443, true),
    ("zecdolprice.uk", 443, true),
...
///
/// This is the main entry point for the discovery service.
/// It periodically discovers and registers new servers in the database.
