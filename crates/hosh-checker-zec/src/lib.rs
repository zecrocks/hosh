//! Hosh Checker ZEC - Zcash/lightwalletd server health checker.
//!
//! This crate provides functionality to check the health of Zcash lightwalletd servers
...
async fn get_info_direct(uri: Uri) -> Result<ServerInfo, Box<dyn Error + Send + Sync>> {
...
/// Test a connection to a specific lightwalletd server.
///
/// Useful for debugging and development.
pub async fn test_connection(target: &str) -> Result<(), Box<dyn Error + Send + Sync>> {
